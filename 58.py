...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, (512), (3,3)) 
        self.batchnorm1 = nn.BatchNorm2d(512)
        self.pool = nn.MaxPool2d(2, 2)
        self.conv2 = nn.Conv2d(512, 1012, (3,3))
        self.batchnorm2 = nn.BatchNorm2d(1012)
        self.conv3 = nn.Conv2d(1012, 2024, (3,3))
        self.batchnorm3 = nn.BatchNorm2d(2024)
        self.conv4 = nn.Conv2d(128, 256, (3,3))
        self.batchnorm4 = nn.BatchNorm2d(256)
        self.conv5 = nn.Conv2d(256, 512, (2,2))
        self.batchnorm5 = nn.BatchNorm2d(512)
        self.fc1 = nn.Linear(72864, 120)
